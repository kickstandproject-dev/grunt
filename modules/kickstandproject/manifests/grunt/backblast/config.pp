...
class kickstandproject::grunt::backblast::config {
  ...
  ini_setting { 'backblast/keystone_authtoken/admin_password':
    ensure  => present,
    notify  => Class['kickstandproject::grunt::backblast::service'],
  ...
  ini_setting { 'backblast/keystone_authtoken/admin_tenant_name':
    ensure  => present,
    notify  => Class['kickstandproject::grunt::backblast::service'],
    path    => '/etc/backblast/backblast.conf',
    require => File['/etc/backblast/backblast.conf'],
  ...
  ini_setting { 'backblast/keystone_authtoken/admin_user':
    ensure  => present,
    notify  => Class['kickstandproject::grunt::backblast::service'],
    path    => '/etc/backblast/backblast.conf',
    require => File['/etc/backblast/backblast.conf'],
  ...
  ini_setting { 'backblast/keystone_authtoken/auth_host':
    ensure  => present,
    notify  => Class['kickstandproject::grunt::backblast::service'],
    path    => '/etc/backblast/backblast.conf',
    require => File['/etc/backblast/backblast.conf'],
  ...
  ini_setting { 'backblast/keystone_authtoken/auth_protocol':
    ensure  => present,
    notify  => Class['kickstandproject::grunt::backblast::service'],
    path    => '/etc/backblast/backblast.conf',
    require => File['/etc/backblast/backblast.conf'],
  ...
  ini_setting { 'backblast/database/connection':
    ensure  => present,
